		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="callout-actions">
					<a href="contact.php" class="button">Become Volunteer</a>

					<span class="callout-separator">
						<span>Or</span>
					</span>

					<a href="donate.php" class="button">Donate For Cause</a>
				</div><!-- /.callout-actions -->
			</div><!-- /.columns large-6 -->
		</div><!-- /.row -->
</div>
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="footer-section">
						...
						<div class="footer-section-body">
							<p><b>Address:</b>sargodha city of pakistan</p>
							...
							<div class="footer-contacts">
								...
								<p>
									...
									info@charitymanagementsystem.com
								</p>
							</div><!-- /.footer-contacts -->
						</div><!-- /.footer-section-body -->
					</div><!-- /.footer-section -->
...
<div class="left-text">Copyright &copy; Charity management system 2021. All Rights Reserved</div>
</div>
        </div>
        </div>
        </div>
