...
<?php require_once('modalbox.php') ?>
                        ...
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    <h4 class="card-title">Sponsored Childs</h4>
  ...
  <div class="form-row">
    <div class="form-group col-lg-12">
      ...
      <input type="text" class="form-control" id="title" value="<?php echo $row2["title"]; ?>" name="title" placeholder="Title">
  ...
  <div class="form-row">
    <div class="form-group col-lg-6">
      ...
      <input type="text" class="form-control" id="title" value="<?php echo $row2["address"]; ?>" name="address" placeholder="Address">
    ...
    <div class="form-group col-lg-6">
      ...
      <input type="number" class="form-control" id="title" value="<?php echo $row2["age"]; ?>" name="age" placeholder="Age">
  ...
  <div class="form-group">
    ...
    <input type="date" class="form-control" name="dob" value="<?php echo $row2["dob"]; ?>" id="dob" placeholder="">
