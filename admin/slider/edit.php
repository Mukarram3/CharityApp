...
<body>
  ...
  <div class="form-row">
    <div class="form-group col-lg-4">
      ...
      <input type="text" class="form-control" id="title" name="title" placeholder="Title" value="<?php echo $row2["title"] ?>">
...
<img src="../images/<?php echo $row2["image"] ?>" alt="loading" width="50" height="50" srcset="">
  ...
  <div class="form-group col-lg-6">
      ...
      <textarea name="description" class="form-control" id=""><?php echo $row2["description"] ?></textarea>
