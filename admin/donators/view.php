                                ...
                                <div class="card-body table-full-width table-responsive">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $query= "SELECT * FROM `donators` ORDER BY `id` ASC";
                                            ...
                                            <tr>
                                                ...
                                                <a href='edit.php?id=<?php echo $row["id"]; ?>&action=edit' type='button' rel='tooltip' title='' class='btn btn-info btn-sm' data-original-title='Edit User'>
